...
const UploadTopBar = (props) => {
    return(
        <>
        <div className="container-fluid" style={{width:"auto", height:"auto", borderTop:"1px solid white", borderBottom:"1px solid white", display:"flex", flexWrap:"wrap"}}>
                    
                    <div className="container-fluid mx-3" style={{height:"auto", width:"185px"}}>
                    ...
                    <div className="container-fluid mx-3" style={{height:"auto", width:"179px"}}>
